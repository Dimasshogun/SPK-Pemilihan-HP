...
<body>
			...
			<div class="section-card" style="padding: 36px 0px">
				<div class="row">
					<div class="col s6">
						...
						<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Mata Kuliah AI Sistem Pendukung Keputusan Prodi Teknik Informatika </p>
					</div>
					<div class="col s6">
						<center>
	...
	<div class="footer-copyright" style="padding: 0px 0px">
		<div class="container">
			<p align="center" style="color: #999">&copy; Sistem Pendukung Keputusan Pemilihan Smartphone 2020.</p>
		</div>
	</div>
	<!-- Footer End -->
